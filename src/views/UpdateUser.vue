...
//对话框显示和隐藏
        ...
        created() {
           ...
           axios.get('http://localhost:8088/getUserById?='+this.$route.params.id).then(function (resp) {
              console.log(resp.data.data)
              this.form.username = resp.data.data.username;
            //   this.form.password = resp.data.data.password;
            //   this.form.checkPass = resp.data.data.password;
...
export default {
    ...
    created() {
        console.log('this.$route.params.id ' + this.$route.params.id);
        axios.get(`http://localhost:8088/getUserById?id=${this.$route.params.id}`).then(resp => {
            console.log(resp.data.data);
            this.form.username = resp.data.data.username;
            // 根据需求是否要获取密码
            // this.form.password = resp.data.data.password;
...
export default {
    ...
    created() {
                ...
                axios.get('http://localhost:8088/getUserById?userId='+this.$route.query.id).then(function(resp){
                    console.log(resp.data.data)
